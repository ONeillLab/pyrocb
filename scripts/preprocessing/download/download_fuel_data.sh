...
unzip -d "$PCB_DATA_DIR/LF2024_FBFM13_CONUS" "$PCB_DATA_DIR/LF2024_FBFM13_CONUS.zip"
...
unzip -d "$PCB_DATA_DIR/LF2024_FBFM13_AK" "$PCB_DATA_DIR/LF2024_FBFM13_AK.zip"
...
unzip -d "$PCB_DATA_DIR/LF2024_FBFM40_CONUS" "$PCB_DATA_DIR/LF2024_FBFM40_CONUS.zip"
...
unzip -d "$PCB_DATA_DIR/LF2024_FBFM40_AK" "$PCB_DATA_DIR/LF2024_FBFM40_AK.zip"
