...
# Uses radii around satellite points to generate an ignition matrix that lerps from the ignition_start_time in the config to the first spotted satellite frame.
