...
pip install rasterio pyproj numpy scipy pandas h5py dill requests psutil pytz paramiko f90nml xmltodict cdsapi requests gdal geopandas matplotlib alpha_shapes imageio
pip install "numpy<2"
