...
pip install rasterio pyproj numpy scipy pandas h5py dill requests psutil pytz paramiko f90nml xmltodict cdsapi requests gdal geopandas matplotlib alpha_shapes
pip install "numpy<2"
