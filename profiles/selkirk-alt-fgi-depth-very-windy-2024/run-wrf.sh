...
#SBATCH --mem=0
#SBATCH --output=/scratch/su386/pyrocb5/out/logs/selkirk-alt-fgi-depth-very-windy-2024/%x_%j.out
#SBATCH --error=/scratch/su386/pyrocb5/out/logs/selkirk-alt-fgi-depth-very-windy-2024/%x_%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=s.dosreis@mail.utoronto.ca

source $SCRATCH/pyrocb5/alliance_can_shell_setup.sh 
