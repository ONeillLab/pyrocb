...
#SBATCH --mem=0
#SBATCH --output=/scratch/su386/pyrocb3/out/logs/selkirk-alt-fgi-depth-2024/%x_%j.out
#SBATCH --error=/scratch/su386/pyrocb3/out/logs/selkirk-alt-fgi-depth-2024/%x_%j.err
