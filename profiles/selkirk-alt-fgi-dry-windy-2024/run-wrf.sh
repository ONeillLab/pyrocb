...
#SBATCH --mem=0
#SBATCH --output=/scratch/su386/pyrocb5/out/logs/selkirk-alt-fgi-dry-windy-2024/%x_%j.out
#SBATCH --error=/scratch/su386/pyrocb5/out/logs/selkirk-alt-fgi-dry-windy-2024/%x_%j.err
